...
sigma_ys_110 = 110000/14.5 #Psi to bar

sigma_t_vs_ys = 0.5*(sigma_a/sigma_ys_110 )+math.sqrt(1-0.75*((sigma_a/sigma_ys_110 )**2))
...
P_burst = 2*sigma_ys_110 *(thickness_13_casing/od_13_casing)
...
print('Fracture gradient:', round(frac_gradient,3), 'Sg')
